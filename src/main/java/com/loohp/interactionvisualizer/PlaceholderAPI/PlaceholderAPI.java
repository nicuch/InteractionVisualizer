    ...
    public String onRequest(OfflinePlayer offlineplayer, String identifier) {
        ...
        if (identifier.equals("itemstand")) {
            if (offlineplayer.isOnline()) {
                ...
                if (InteractionVisualizer.itemStand.contains(player.getUniqueId())) {
                    return "enabled";
                }
                return "disabled";
            }
        ...
        if (identifier.equals("itemdrop")) {
            if (offlineplayer.isOnline()) {
                Player player = offlineplayer.getPlayer();
                if (InteractionVisualizer.itemDrop.contains(player.getUniqueId())) {
                    return "enabled";
                }
                return "disabled";
            }
        ...
        if (identifier.equals("hologram")) {
            if (offlineplayer.isOnline()) {
                Player player = offlineplayer.getPlayer();
                if (InteractionVisualizer.holograms.contains(player.getUniqueId())) {
                    return "enabled";
                }
                return "disabled";
            }
