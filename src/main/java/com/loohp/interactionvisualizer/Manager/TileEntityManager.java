...
public class TileEntityManager {
    ...
    private static final Set<Object[]> chunks = new HashSet<>();
    private static HashMap<String, List<Block>> current = new HashMap<>();
    private static HashMap<String, List<Block>> upcomming = new HashMap<>();
    ...
    public static void run() {
        ...
        Bukkit.getScheduler().runTaskLater(plugin, () -> {
            ...
            Bukkit.getScheduler().runTaskLater(plugin, () -> {
                ...
                Bukkit.getScheduler().runTaskLater(plugin, TileEntityManager::run, nextupdate);
            }, nextnext);
        }, next);
    }
